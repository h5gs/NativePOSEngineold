...
class DbConfig
{
    ...
    static function getConf(){
        ...
        if (($url=getenv("DATABASE_URL"))!==false) {
            ...
            self::$_port = $url["port"];
        } else if (file_exists($_SERVER['DOCUMENT_ROOT'] . $_SERVER['APP_ROOT'] . 'library/wpos/dbconfigs.php')){
            // legacy config (still used for alpha/demo versions)
            require($_SERVER['DOCUMENT_ROOT'] . $_SERVER['APP_ROOT'] . 'library/wpos/dbconfigs.php');
